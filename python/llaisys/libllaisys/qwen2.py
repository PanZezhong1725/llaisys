from ctypes import POINTER, c_int64, c_size_t, c_float, c_int, Structure, c_void_p, c_void_p
...
def load_qwen2(lib):
    ...
    # llaisysQwen2LoadWeight
    lib.llaisysQwen2LoadWeight.argtypes = [llaisysTensor_t, c_void_p, c_size_t]
