...
#define ILUVATAR_CUDA_CHECK(expr)                                \
    do {                                                         \
        ::llaisys::device::iluvatar::checkCudaError(             \
            (expr), #expr, __FILE__, __LINE__                    \
        );                                                       \
    } while (0)


#define ILUVATAR_CUDA_KERNEL_CHECK() \
...
#define ILUVATAR_CUBLAS_CHECK(expr)                              \
    do {                                                         \
        ::llaisys::device::iluvatar::checkCublasError(           \
            (expr), #expr, __FILE__, __LINE__                    \
        );                                                       \
    } while (0)
